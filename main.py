...
def AddBlog():
    ...
    if request.method == 'POST':
        ...
        if new_title == "":
            error["title_blank"] = "we need both a title and a body!"
        if new_body == "":
            error["body_blank"] = "we need both a title and a body!"
...
def register():
    ...
    if request.method == 'POST':
        ...
        if password == "":
            ...
            if password != verify:
                error["verify_error"] = "Password and password verification must match"

        existing_user = User.query.filter_by(username=username).first()
        if existing_user:
            error["name_error"] = "Username already exists!"
    ...
    return render_template("register.html", title= "Signup for this Blog",
